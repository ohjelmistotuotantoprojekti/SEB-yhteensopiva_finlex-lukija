...
test('language stays after back button is pressed', async ({ page }) => {
    pass
  })

})

describe("Case law page", () => {
  beforeAll(async ({ page }) => {
...
test('searchbar gives error (fin)', async ({ page }) => {
    pass
  })

test('searchbar gives error (swe)', async ({ page }) => {
    pass
  })
...
test('single case can be searched (fin)', async ({ page }) => {
    pass
  })

test('single case can be searched (swe)', async ({ page }) => {
    pass
  })

test('single case law can be opened', async ({ page }) => {
    pass
  })
...
test('back button brings back to case law page', async ({ page }) => {
    pass
  })
